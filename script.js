...
function forecastapihandlingfn(city) {
  ...
  let apiUrl = `https://api.shecodes.io/weather/v1/forecast?query=${city}&key=t7a4be44f280a0ace73854a28fo70b86&units=metric`;

  axios.get(`apiUrl`).then(forecastfn);
}
forecastapihandlingfn();
